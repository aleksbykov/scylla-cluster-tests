...
from . import wait
from .utils import log_run_info, retrying, get_data_dir_path, Distro, get_job_name, S3Storage
        ...
        try:
            ...
            for n, node in enumerate(self.nodes):
                ...
                # since there is only one monitoring node returning here
                    screenshots.append(S3Storage.upload_file_to_s3(snapshot_path))
                return screenshots
    ...
    def download_monitor_data(self):
        for node in self.nodes:
            try:
                ...
                return S3Storage.upload_file_to_s3(zipped_data_path)
            except Exception, details:
