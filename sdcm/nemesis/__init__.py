...
from sdcm.utils.diagnostic_collector.views import (
    MVDiagnosticCollector,
    AbortExceptionHandler,
    RaiseExceptionOnCollectDiagnosticCollector,
)
...
class NemesisRunner:
    ...
    def disrupt_kill_mv_building_coordinator(self):
        ...
        with (
            ...
            collect_diagnostics(
                MVDiagnosticCollector(session, name="MVD1"),
                MVDiagnosticCollector(session, name="MVD2"),
                RaiseExceptionOnCollectDiagnosticCollector(session, exception_handler=AbortExceptionHandler()),
                MVDiagnosticCollector(session, name="MVD3"),
            ),
        ):
