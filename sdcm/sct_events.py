...
class GeminiToolEvent(SctEvent):
    def __init__(self, type, cmd, result=None):
        super(GeminiToolEvent, self).__init__()
        self.type = type
        self.cmd = cmd
    ...
    def __str__(self):
        return self.msg.format(super(GeminiToolEvent, self).__str__(), self)
...
class GeminiToolLogEvent(DatabaseLogEvent):
    pass
