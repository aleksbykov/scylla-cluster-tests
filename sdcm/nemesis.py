...
class Nemesis:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def disrupt_refusing_connection_with_block_scylla_ports_on_banned_node(self):
        self._refuse_connection_from_banned_node(use_iptables=True)

    def disrupt_refusing_connection_with_send_sigstop_signal_to_scylla_on_banned_node(self):
...
class IsolateNodeWithProcessSignalNemesis(Nemesis):
    ...
    def disrupt(self):
        self.disrupt_refusing_connection_with_send_sigstop_signal_to_scylla_on_banned_node()
...
class IsolateNodeWithIptableRuleNemesis(Nemesis):
    ...
    def disrupt(self):
        self.disrupt_refusing_connection_with_block_scylla_ports_on_banned_node()
